...
%"pairnumber" by the number of the pair.    %Which randomization sequence will be used to present
...
try
    DefaultVariables %other script (screen, font, trial parameters etc)
   ...
   %Create OutputResp file 
    ...
    if sequence == 4
        ...
        %image/no image
        samef=3;
        [IN,~, destinationRect, files70]  = loadControlPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/B2','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A4', 70, win1, cfg.rescaleRatio,samef);
        %no image/image
        samef=4;
        [NI,~, destinationRect, files70]  = loadControlPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A4','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/B1', 70, win1, cfg.rescaleRatio,samef);
        
    elseif sequence == 5
       %same images
        samef=1; %will have to change path of these folders on presentation computer
        [SBD,~, destinationRect, files140]  = loadBlockPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A2','INUTIL', 140, win1, cfg.rescaleRatio,samef);
        %different images
        samef=2;
        [DBD,~, destinationRect, files140]  = loadBlockPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A1','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A3', 140, win1, cfg.rescaleRatio,samef);
        %image/no image
        samef=3;
        [IN,~, destinationRect, files70]  = loadControlPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/B2','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A4', 70, win1, cfg.rescaleRatio,samef);
        %no image/image
    ...
    elseif sequence == 6
      %same images
        samef=1; %will have to change path of these folders on presentation computer
        [SBD,~, destinationRect, files140]  = loadBlockPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A1','INUTIL', 140, win1, cfg.rescaleRatio,samef);
        %different images
        samef=2;
        [DBD,~, destinationRect, files140]  = loadBlockPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A3','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A2', 140, win1, cfg.rescaleRatio,samef);
        %image/no image
        samef=3;
        [IN,~, destinationRect, files70]  = loadControlPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/B2','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A4', 70, win1, cfg.rescaleRatio,samef);
        %no image/image
    ...
    elseif sequence == 1
       %same images
        ...
        %different images
        samef=2;
        [DBD,~, destinationRect, files140]  = loadBlockPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A1','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A2', 140, win1, cfg.rescaleRatio,samef);
        %image/no image
        samef=3;
    ...
    elseif sequence == 2
        ...
        %different images
        samef=2;
        [DBD,~, destinationRect, files140]  = loadBlockPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A3','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A1', 140, win1, cfg.rescaleRatio,samef);
        %image/no image
        samef=3;
        [IN,~, destinationRect, files70]  = loadControlPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/B1','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A4', 70, win1, cfg.rescaleRatio,samef);
        %no image/image
    ...
    elseif sequence == 3
       %same images
        ...
        %different images
        samef=2;
        [DBD,~, destinationRect, files140]  = loadBlockPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A2','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A3', 140, win1, cfg.rescaleRatio,samef);
        %image/no image
        samef=3;
        [IN,~, destinationRect, files70]  = loadControlPics_SM('/home/presentation/Desktop/SemiMixed Experiment/Stimulus/B1','/home/presentation/Desktop/SemiMixed Experiment/Stimulus/A4', 70, win1, cfg.rescaleRatio,samef);
        %no image/image
    ...
    %"presentCondition".
    %
    %'conditions' is a matrix containing as many rows as pairs of
    %participants. Each row contains the partially randomized list of numbers
    %3,8,9,2 corresponding to the 4 experimental conditions i.e each cell of the row
    %decides which condition will be shown to participants.
    %
    ...
    for i=1:420 % i corresponds to the number of trials in the experiment. This experiment has 1000 trials
        ...
        presentCondition_SM;%this script determines which condition will be presented depending on the number written in the cells of the folder a   
