...
%
%%%INPUT given to function: (folderToLoadFrom,folderToLoadFrom2, nbFilesExpected, win, rescaleRatio,samef)
...
%win: returns parameters of the screen set in Main script
%rescaleRatio: returns display parameters
%
...
[W, H] = Screen('WindowSize', win); %Returns the width and height of window or screen in units of pixels
