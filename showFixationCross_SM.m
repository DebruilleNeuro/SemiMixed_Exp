...
%the cross used is the same as in the trials "no image"
...
%simplicity, not for optimization. For more detailed annotations see
...
crossimage= Cross(x.cross(1)); %chooses picture position in array (1 out of 1)
